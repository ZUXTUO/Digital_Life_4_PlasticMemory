class EmoteDevice
{
    ...
    onStartAnimation() {
        if (typeof(EmoteModule) !== "undefined"
            && typeof(EmoteModule.onStartEmoteAnimation) !== "undefined")
          EmoteModule.onStartEmoteAnimation(this);
        else
    ...
    onStopAnimation() {
        if (typeof(EmoteModule) !== "undefined"
            && typeof(EmoteModule.onStopEmoteAnimation) !== "undefined")
          EmoteModule.onStopEmoteAnimation(this);
        else
...
class EmotePlayer
{
    ...
    get practicalHide() {
        if (! this.initialized)
            ...
            return this._hide || (this._globalA == 0 && EmotePlayer_GetVariable(this.playerId, "_globalA") == 0);
    }
    ...
    get transformOrderMask() {
      return this._transformOrderMask;
    }
    set transformOrderMask(val) {
      this._transformOrderMask = val;
      if (this.initialized) {
          this.modified = true;
          EmotePlayer_SetTransformOrderMask(this.playerId, val);
      }
    }
...
for (let label of [ 'hairScale', 'partsScale', 'bustScale' ]) {
...
EmotePlayer.releaseDevice = () => {
    if (--EmotePlayer.deviceRefCount <= 0) {
        if (EmotePlayer.device && typeof EmotePlayer.device.destroy === "function") {
